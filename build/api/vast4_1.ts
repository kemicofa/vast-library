...
class Verification_24 extends VastElement<AdVerifications_23> {
  ...
  public attachExecutableResource(content: string, attributes: {
    apiFramework: string, 
    language?: string, 
    type?: string
  ...
  public addExecutableResource(content: string, attributes: {
    apiFramework: string, 
    language?: string, 
    type?: string
  } = {}): Verification_24 {
...
class AdVerifications_23 extends VastElement<InLine_7> {
  public attachVerification(attributes: {
    ...
    const newElem = new Verification_24('Verification', this, {"attrs":["vendor"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class ClosedCaptionFiles_44 extends VastElement<MediaFiles_40> {
  public attachClosedCaptionFile(content: string, attributes: {
    type?: string, 
    language?: string
  ...
  public addClosedCaptionFile(content: string, attributes: {
    type?: string, 
    language?: string
...
class MediaFiles_40 extends VastElement<Linear_37> {
  public attachMezzanine(content: string, attributes: {
  ...
  public addMezzanine(content: string, attributes: {
    delivery: "progressive"|"streaming", 
    type: string, 
    width: string, 
    height: string, 
  ...
  public attachInteractiveCreativeFile(content: string, attributes: {
    type?: string, 
    apiFramework?: string, 
  ...
  public addInteractiveCreativeFile(content: string, attributes: {
    type?: string, 
    apiFramework?: string, 
    variableDuration?: string
  } = {}): MediaFiles_40 {
...
class Icons_52 extends VastElement<Linear_37> {
  public attachIcon(attributes: {
    ...
    const newElem = new Icon_53('Icon', this, {"attrs":["program","width","height","xPosition","yPosition","duration","offset","apiFramework","pxratio"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class NonLinearAds_61 extends VastElement<Creative_33> {
  public attachNonLinear(attributes: {
    ...
    const newElem = new NonLinear_62('NonLinear', this, {"attrs":["id","width","height","expandedWidth","expandedHeight","scalable","maintainAspectRatio","apiFramework","minSuggestedDuration"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class CompanionAds_67 extends VastElement<Creative_33> {
  public attachCompanion(attributes: {
    ...
    const newElem = new Companion_68('Companion', this, {"attrs":["width","height","id","assetWidth","assetHeight","expandedWidth","expandedHeight","apiFramework","adSlotID","pxratio","renderingMode"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
class Creative_33 extends VastElement<Creatives_32> {
  ...
  public attachLinear(attributes: {
    ...
    const newElem = new Linear_37('Linear', this, {"attrs":["skipoffset"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
  ...
  public attachCompanionAds(attributes: {
    ...
    const newElem = new CompanionAds_67('CompanionAds', this, {"attrs":["required"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
class Creatives_32 extends VastElement<InLine_7> {
  public attachCreative(attributes: {
    ...
    const newElem = new Creative_33('Creative', this, {"attrs":["id","sequence","adId","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
class InLine_7 extends VastElement<Ad_6> {
  ...
  public attachAdvertiser(content: string, attributes: {
    id?: string
  } = {}): Advertiser_14 {
  ...
  public addAdvertiser(content: string, attributes: {
    id?: string
  } = {}): InLine_7 {
  ...
  public attachViewableImpression(attributes: {
    ...
    const newElem = new ViewableImpression_19('ViewableImpression', this, {"attrs":["id"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class Verification_89 extends VastElement<AdVerifications_88> {
  ...
  public attachBlockedAdCategories(content: string, attributes: {
    authority: string
  ...
  public addBlockedAdCategories(content: string, attributes: {
    authority: string
  } = {}): Verification_89 {
...
class AdVerifications_88 extends VastElement<Wrapper_78> {
  public attachVerification(attributes: {
    ...
    const newElem = new Verification_89('Verification', this, {"attrs":["vendor"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class Icons_106 extends VastElement<Linear_100> {
  public attachIcon(attributes: {
    ...
    const newElem = new Icon_107('Icon', this, {"attrs":["program","width","height","xPosition","yPosition","duration","offset","apiFramework","pxratio"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class NonLinearAds_116 extends VastElement<Creative_99> {
  public attachNonLinear(attributes: {
    ...
    const newElem = new NonLinear_117('NonLinear', this, {"attrs":["id","width","height","expandedWidth","expandedHeight","scalable","maintainAspectRatio","apiFramework","minSuggestedDuration"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class CompanionAds_122 extends VastElement<Creative_99> {
  public attachCompanion(attributes: {
    ...
    const newElem = new Companion_123('Companion', this, {"attrs":["width","height","id","assetWidth","assetHeight","expandedWidth","expandedHeight","apiFramework","adSlotID","pxratio","renderingMode"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
class Creative_99 extends VastElement<Creatives_98> {
  ...
  public attachCompanionAds(attributes: {
    ...
    const newElem = new CompanionAds_122('CompanionAds', this, {"attrs":["required"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
class Creatives_98 extends VastElement<Wrapper_78> {
  public attachCreative(attributes: {
    ...
    const newElem = new Creative_99('Creative', this, {"attrs":["id","sequence","adId"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
class Wrapper_78 extends VastElement<Ad_6> {
  ...
  public attachViewableImpression(attributes: {
    ...
    const newElem = new ViewableImpression_84('ViewableImpression', this, {"attrs":["id"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class Ad_6 extends VastElement<VAST_4> {
  ...
  public attachWrapper(attributes: {
    ...
    const newElem = new Wrapper_78('Wrapper', this, {"attrs":["followAdditonalWrappers","allowMultipleAds","fallbackOnNoAd"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
class VAST_4 extends VastElement<apiv4_1> {
  ...
  public attachAd(attributes: {
    ...
    const newElem = new Ad_6('Ad', this, {"attrs":["id","sequence","conditionalAd","adType"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
