...
class Icons_30 extends VastElement<Linear_19> {
  public attachIcon(attributes: {
    ...
    const newElem = new Icon_31('Icon', this, {"attrs":["program","width","height","xPosition","yPosition","duration","offset","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class CompanionAds_39 extends VastElement<Creative_16> {
  public attachCompanion(attributes: {
    ...
    const newElem = new Companion_40('Companion', this, {"attrs":["id","width","height","assetWidth","assetHeight","expandedWidth","expandedHeight","apiFramework","adSlotID"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class NonLinear_51 extends VastElement<NonLinearAds_50> {
  ...
  public attachNonLinearClickTracking(content: string, attributes: {
    id?: string
  ...
  public addNonLinearClickTracking(content: string, attributes: {
    id?: string
  } = {}): NonLinear_51 {
...
class NonLinearAds_50 extends VastElement<Creative_16> {
  public attachNonLinear(attributes: {
    ...
    const newElem = new NonLinear_51('NonLinear', this, {"attrs":["id","width","height","expandedWidth","expandedHeight","scalable","maintainAspectRatio","minSuggestedDuration","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class Creative_16 extends VastElement<Creatives_15> {
  ...
  public attachLinear(attributes: {
    ...
    const newElem = new Linear_19('Linear', this, {"attrs":["skipoffset"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
  public attachCompanionAds(attributes: {
    ...
    const newElem = new CompanionAds_39('CompanionAds', this, {"attrs":["required"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class Creatives_15 extends VastElement<InLine_6> {
  public attachCreative(attributes: {
    ...
    const newElem = new Creative_16('Creative', this, {"attrs":["id","sequence","adID","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class Icons_75 extends VastElement<Linear_69> {
  public attachIcon(attributes: {
    ...
    const newElem = new Icon_76('Icon', this, {"attrs":["program","width","height","xPosition","yPosition","duration","offset","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class CompanionAds_84 extends VastElement<Creative_68> {
  public attachCompanion(attributes: {
    ...
    const newElem = new Companion_85('Companion', this, {"attrs":["id","width","height","assetWidth","assetHeight","expandedWidth","expandedHeight","apiFramework","adSlotID"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class NonLinearAds_95 extends VastElement<Creative_68> {
  public attachNonLinear(attributes: {
    ...
    const newElem = new NonLinear_96('NonLinear', this, {"attrs":["id","width","height","expandedWidth","expandedHeight","scalable","maintainAspectRatio","minSuggestedDuration","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class Creative_68 extends VastElement<Creatives_67> {
  ...
  public attachCompanionAds(attributes: {
    ...
    const newElem = new CompanionAds_84('CompanionAds', this, {"attrs":["required"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class Creatives_67 extends VastElement<Wrapper_62> {
  public attachCreative(attributes: {
    ...
    const newElem = new Creative_68('Creative', this, {"attrs":["id","sequence","adID"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class Ad_5 extends VastElement<VAST_3> {
  ...
  public attachWrapper(attributes: {
    ...
    const newElem = new Wrapper_62('Wrapper', this, {"attrs":["followAdditonalWrappers","allowMultipleAds","fallbackOnNoAd"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
class VAST_3 extends VastElement<apiv3> {
  ...
  public attachAd(attributes: {
    ...
    const newElem = new Ad_5('Ad', this, {"attrs":["id","sequence"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
class apiv3 extends VastElement<apiv3> {
  public attachVAST(attributes: {
    ...
    const newElem = new VAST_3('VAST', this, {"attrs":["version"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
