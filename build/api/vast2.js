...
class VideoClicks_18 extends VastElement {
  ...
  attachClickThrough(content) {
    const newElem = new ClickThrough_19(
      "ClickThrough",
      this,
      {} /*: Infos*/,
      content
  ...
  attachClickTracking(content) {
    const newElem = new ClickTracking_20(
      "ClickTracking",
      this,
      {} /*: Infos*/,
      content
...
class Linear_13 extends VastElement {
  ...
  attachTrackingEvents() {
    const newElem = new TrackingEvents_15(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
  ...
  attachAdParameters(content) {
    const newElem = new AdParameters_17(
      "AdParameters",
      this,
      {} /*: Infos*/,
      content
...
class Companion_25 extends VastElement {
  ...
  attachIFrameResource(content) {
    const newElem = new IFrameResource_27(
      "IFrameResource",
      this,
      {} /*: Infos*/,
      content
  ...
  attachHTMLResource(content) {
    const newElem = new HTMLResource_28(
      "HTMLResource",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachTrackingEvents() {
    const newElem = new TrackingEvents_29(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
   ...
   */
  attachAdParameters(content) {
    const newElem = new AdParameters_33(
      "AdParameters",
      this,
      {} /*: Infos*/,
      content
...
class NonLinear_35 extends VastElement {
   ...
   */
  attachIFrameResource(content) {
    const newElem = new IFrameResource_37(
      "IFrameResource",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachHTMLResource(content) {
    const newElem = new HTMLResource_38(
      "HTMLResource",
      this,
      {} /*: Infos*/,
      content
...
class NonLinearAds_34 extends VastElement {
   ...
   */
  attachTrackingEvents() {
    const newElem = new TrackingEvents_39(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
   ...
   */
  attachAdParameters(content) {
    const newElem = new AdParameters_42(
      "AdParameters",
      this,
      {} /*: Infos*/,
      content
...
class InLine_4 extends VastElement {
  ...
  attachDescription(content) {
    const newElem = new Description_7(
      "Description",
      this,
      {} /*: Infos*/,
      content
...
class VideoClicks_55 extends VastElement {
   ...
   */
  attachClickThrough(content) {
    const newElem = new ClickThrough_56(
      "ClickThrough",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachClickTracking(content) {
    const newElem = new ClickTracking_57(
      "ClickTracking",
      this,
      {} /*: Infos*/,
      content
...
class Linear_52 extends VastElement {
   ...
   */
  attachTrackingEvents() {
    const newElem = new TrackingEvents_53(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
...
class Companion_60 extends VastElement {
   ...
   */
  attachIFrameResource(content) {
    const newElem = new IFrameResource_62(
      "IFrameResource",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachHTMLResource(content) {
    const newElem = new HTMLResource_63(
      "HTMLResource",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachTrackingEvents() {
    const newElem = new TrackingEvents_64(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
   ...
   */
  attachAdParameters(content) {
    const newElem = new AdParameters_68(
      "AdParameters",
      this,
      {} /*: Infos*/,
      content
...
class NonLinear_70 extends VastElement {
   ...
   */
  attachIFrameResource(content) {
    const newElem = new IFrameResource_72(
      "IFrameResource",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachHTMLResource(content) {
    const newElem = new HTMLResource_73(
      "HTMLResource",
      this,
      {} /*: Infos*/,
      content
...
class NonLinearAds_69 extends VastElement {
   ...
   */
  attachTrackingEvents() {
    const newElem = new TrackingEvents_74(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
...
class Wrapper_45 extends VastElement {
  ...
  attachVASTAdTagURI(content) {
    const newElem = new VASTAdTagURI_47(
      "VASTAdTagURI",
      this,
      {} /*: Infos*/,
      content
