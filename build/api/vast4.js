...
class ViewableImpression_17 extends VastElement {
  ...
  attachNotViewable(content) {
    const newElem = new NotViewable_19(
      "NotViewable",
      this,
      {} /*: Infos*/,
      content
...
class MediaFiles_36 extends VastElement {
  ...
  attachMezzanine(content) {
    const newElem = new Mezzanine_37(
      "Mezzanine",
      this,
      {} /*: Infos*/,
      content
...
class TrackingEvents_44 extends VastElement {
  ...
  /**
   * @param {string} content
   * @param {{offset: string, event:("mute"|"unmute"|"pause"|"resume"|"rewind"|"skip"|"playerExpand"|"playerCollapse"|"otherAdInteraction"|"start"|"firstQuartile"|"midpoint"|"thirdQuartile"|"complete"|"acceptInvitationLinear"|"timeSpentViewing"|"progress"|"offset")}} attributes
   * @returns {Tracking_45}
   */
...
class Icon_47 extends VastElement {
  ...
  attachIFrameResource(content) {
    const newElem = new IFrameResource_49(
      "IFrameResource",
      this,
      {} /*: Infos*/,
      content
  ...
  attachHTMLResource(content) {
    const newElem = new HTMLResource_50(
      "HTMLResource",
      this,
      {} /*: Infos*/,
      content
...
class Linear_33 extends VastElement {
  ...
  attachTrackingEvents() {
    const newElem = new TrackingEvents_44(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
...
class NonLinearAds_55 extends VastElement {
   ...
   */
  attachTrackingEvents() {
    const newElem = new TrackingEvents_59(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
...
class Companion_62 extends VastElement {
   ...
   */
  attachIFrameResource(content) {
    const newElem = new IFrameResource_64(
      "IFrameResource",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachHTMLResource(content) {
    const newElem = new HTMLResource_65(
      "HTMLResource",
      this,
      {} /*: Infos*/,
      content
...
class Creative_29 extends VastElement {
  ...
  attachUniversalAdId(content, attributes) {
    const newElem = new UniversalAdId_30(
      "UniversalAdId",
      this,
      { attrs: ["idRegistry", "idValue"] } /*: Infos*/,
      content,
      attributes
    );
    this.childs.push(newElem);
  ...
  attachCreativeExtensions() {
    const newElem = new CreativeExtensions_31(
      "CreativeExtensions",
      this,
      {} /*: Infos*/
    );
...
class InLine_7 extends VastElement {
  ...
  attachDescription(content) {
    const newElem = new Description_12(
      "Description",
      this,
      {} /*: Infos*/,
      content
  ...
  attachAdvertiser(content) {
    const newElem = new Advertiser_13(
      "Advertiser",
      this,
      {} /*: Infos*/,
      content
  ...
  attachAdVerifications() {
    const newElem = new AdVerifications_21(
      "AdVerifications",
      this,
      {} /*: Infos*/
    );
...
class ViewableImpression_78 extends VastElement {
   ...
   */
  attachNotViewable(content) {
    const newElem = new NotViewable_80(
      "NotViewable",
      this,
      {} /*: Infos*/,
      content
...
class Icon_96 extends VastElement {
   ...
   */
  attachIFrameResource(content) {
    const newElem = new IFrameResource_98(
      "IFrameResource",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachHTMLResource(content) {
    const newElem = new HTMLResource_99(
      "HTMLResource",
      this,
      {} /*: Infos*/,
      content
...
class Linear_89 extends VastElement {
   ...
   */
  attachTrackingEvents() {
    const newElem = new TrackingEvents_90(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
...
class NonLinearAds_105 extends VastElement {
   ...
   */
  attachTrackingEvents() {
    const newElem = new TrackingEvents_109(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
...
class Companion_112 extends VastElement {
   ...
   */
  attachIFrameResource(content) {
    const newElem = new IFrameResource_114(
      "IFrameResource",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachHTMLResource(content) {
    const newElem = new HTMLResource_115(
      "HTMLResource",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachTrackingEvents() {
    const newElem = new TrackingEvents_120(
      "TrackingEvents",
      this,
      {} /*: Infos*/
    );
...
class Wrapper_72 extends VastElement {
  ...
  attachVASTAdTagURI(content) {
    const newElem = new VASTAdTagURI_74(
      "VASTAdTagURI",
      this,
      {} /*: Infos*/,
      content
   ...
   */
  attachAdVerifications() {
    const newElem = new AdVerifications_82(
      "AdVerifications",
      this,
      {} /*: Infos*/
    );
...
class VAST_4 extends VastElement {
  ...
  attachAd(attributes) {
    const newElem = new Ad_6(
      "Ad",
      this,
      { attrs: ["id", "sequence", "conditionalAd"] } /*: Infos*/,
      attributes
    );
    this.childs.push(newElem);
    return newElem;
