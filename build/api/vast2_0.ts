...
class CompanionAds_24 extends VastElement<Creative_12> {
  public attachCompanion(attributes: {
    ...
    const newElem = new Companion_25('Companion', this, {"attrs":["id","width","height","expandedWidth","expandedHeight","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class NonLinearAds_34 extends VastElement<Creative_12> {
  public attachNonLinear(attributes: {
    ...
    const newElem = new NonLinear_35('NonLinear', this, {"attrs":["id","width","height","expandedWidth","expandedHeight","scalable","maintainAspectRatio","minSuggestedDuration","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class Creatives_11 extends VastElement<InLine_4> {
  public attachCreative(attributes: {
    ...
    const newElem = new Creative_12('Creative', this, {"attrs":["id","sequence","adID"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class CompanionAds_59 extends VastElement<Creative_51> {
  public attachCompanion(attributes: {
    ...
    const newElem = new Companion_60('Companion', this, {"attrs":["id","width","height","expandedWidth","expandedHeight","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class NonLinearAds_69 extends VastElement<Creative_51> {
  public attachNonLinear(attributes: {
    ...
    const newElem = new NonLinear_70('NonLinear', this, {"attrs":["id","width","height","expandedWidth","expandedHeight","scalable","maintainAspectRatio","minSuggestedDuration","apiFramework"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
...
class Creatives_50 extends VastElement<Wrapper_45> {
  public attachCreative(attributes: {
    ...
    const newElem = new Creative_51('Creative', this, {"attrs":["id","sequence","adID"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
...
class apiv2 extends VastElement<apiv2> {
  public attachVAST(attributes: {
    ...
    const newElem = new VAST_2('VAST', this, {"attrs":["version"]}, attributes);
    this.childs.push(newElem);
    return newElem;
  }
}
